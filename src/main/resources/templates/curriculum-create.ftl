...
<form name="curriculum" action="" method="POST">
    ...
    <div class="mb-3" style="width: 50%">
        ...
        <select class="form-select" id="exampleInputEmail1" aria-describedby="emailHelp" <@spring.formSingleSelect "form.student" students ""/>
    </div>
    <div class="mb-3" style="width: 50%">
        <label for="exampleInputEmail1" class="form-label">Subject</label>
        <select class="form-select" id="exampleInputEmail1" aria-describedby="emailHelp" <@spring.formSingleSelect "form.subject" subjects ""/>
    </div>
    <div class="mb-3" style="width: 50%">
        <label for="exampleInputEmail1" class="form-label">Mark</label>
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" <@spring.formInput "form.mark" "" "text"/>
    </div>
    <div class="mb-3" style="width: 50%">
